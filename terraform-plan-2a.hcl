...
Terraform will perform the following actions:
 ...
 = data "template_file" "compute_instance_template_self_link"  {
  ...
  # module.consul_cluster.google_compute_instance_template.consul_server_public[0] must be [31mreplaced
+/ resource "google_compute_instance_template" "consul_server_public" {
      ...
      ~ network_interface {
          ...
          + msubnetwork_project = "hc-c858ec7b69a3402a8f35fd287c2" [31m# forces replacement
